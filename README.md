...
Here is the interactive IGV browser for our sample of detected boundary regions with CTCF and cohesin signal tracks. [Open the interactive IGV viewer](https://github.com/dozmorovlab/EpiTADformer/blob/main/igv/index.html).
