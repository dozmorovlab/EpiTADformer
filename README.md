...
Here is the interactive IGV browser for a sample of detected boundary regions with CTCF and cohesin signal tracks: [Open the interactive IGV viewer](https://dozmorovlab.github.io/EpiTADformer/igv/).
